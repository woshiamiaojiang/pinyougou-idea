...
// TODO 实现商品分类的新增 未能获取sellerId  kind编辑器
    /**
     * 根据父ID查询所有子类
     * http://localhost:18082/itemCat/parant/1.shtml 查询父ID=1的所有分类
     * http://localhost:18082/itemCat/parant/2.shtml 查询父ID=2的所有分类
     * @param id
     * @return
     */
    @RequestMapping(value = "/parent/{id}",method = RequestMethod.GET)
    public List<ItemCat> getByParentId(@PathVariable(value = "id") long id){
